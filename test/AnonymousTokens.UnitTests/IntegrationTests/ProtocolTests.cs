...
namespace AnonymousTokens.UnitTests.IntegrationTests
{
    public class ProtocolTests
    {
        ...
        public ProtocolTests()
        {
            ...
            var wrongPrivateKey = privateKey.Add(BigInteger.One);

            _initiator = new Initiator(publicKey);

            _tokenGenerator = new TokenGenerator(publicKey, privateKey);
            _corruptedTokenGenerator = new TokenGenerator(publicKey, wrongPrivateKey);
        ...
        public void Run_FailWhenWIsInvalid()
        {
            ...
            var isVerified = _tokenVerifier.VerifyToken(_ecParameters.Curve, t, wrongW);
